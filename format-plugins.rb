# Copyright
# Part of Username Anarchy with marb08 contributions
...
Plugin.define "first_last" do
        def generate(n)
                #n.format("%f.%l")
                n.format_anna("anna_key")
        end
end
...
Plugin.define "first[1]last[7]" do
        def generate(n)
                (n.firstname.to_s[0..0]) + (n.lastname.to_s[0..6]) unless n.firstname.nil? or n.lastname.nil?
        end
end

Plugin.define "first[7]last[1]" do
        def generate(n)
                (n.firstname.to_s[0..6]) + (n.lastname.to_s[0..0]) unless n.firstname.nil? or n.lastname.nil?
        end
end

Plugin.define "first[5]last[5]" do
        def generate(n)
                (n.firstname.to_s[0..4]) + (n.lastname.to_s[0..4]) unless n.firstname.nil? or n.lastname.nil?
        end
end
...
Plugin.define "l_first" do
        def generate(n)
                n.format_anna("k_anna")
        end
end
...
Plugin.define "last_first" do
        def generate(n)
                n.format_anna("key_anna")
        end
end
